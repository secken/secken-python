...
class api(object):
    ...
    def setLevel(self, level, www="api"):
        self.__www = www
        self.__version = level
    ...
    def getBindingCode(self):
        ...
        try:
            ...
            if self.__debug:
                print "getBindingCode - __Get__ - " + e
            json_dict = {
                "status": -1,
        ...
        if event_id is None:
            ...
            if self.__debug:
                print "getBindingCode - Not Found event_id - " + e
    ...
    def getLoginCode(self):
        ...
        if event_id is None:
            ...
            if self.__debug:
                print "getLoginCode - Not Found event_id - " + e
    ...
    def verifyOneClick(self, userid, action="", ip=None, username=None):
        ...
        try:
            ...
            if self.__debug:
                print "verifyOneClick - __Post__ - " + e
            json_dict = {
                "status": -1,
                "description": "network has exception"
            }
        ...
        if event_id is None:
            if self.__debug:
                print "verifyOneClick - Not Found event_id - " + e
